...
extern char *movieCategoryStr[6]  ;
...
extern int a,b;                   /*a,b are the coefficients of the hash function*/
extern int prime_num;             /*prime_num is the prime number used in the hash function*/
extern movie_t *sentinel;         /*sentinel is the sentinel of the movie binary tree*/
...
void print_movies_inorder(movie_t *root);
 #endif
